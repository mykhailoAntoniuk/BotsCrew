...
public class CountOfEmployeeCommandStrategyImpl implements CommandStrategy {
    private final DepartmentService departmentService;
    private static final String COMMAND_PATTERN = "show count of employee for (.+)?";
    ...
    public String process(String command) {
        ...
        return departmentService.getCountOfEmployee(parsedValue);
    }
